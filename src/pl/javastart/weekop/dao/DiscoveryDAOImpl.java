...
public class DiscoveryDAOImpl implements DiscoveryDAO {
    ...
    private static final String READ_ALL_DISCOVERIES =
            "SELECT users.user_id, username, email, is_active, password, " +
                    "discovery_id, name, description, url, date, up_vote, down_vote "
    ...
    public List<Discovery> getAll() {
        List<Discovery> allDiscoveries = template.query(READ_ALL_DISCOVERIES, new DiscoveryRowMapper());
