...
public class UserDAOImpl implements UserDAO{
    ...
    private static final String READ_USER =
            "SELECT user_id, username, password, email, is_active FROM users WHERE user_id=:id;";
    private static final String READ_USER_BY_USERNAME =
            "SELECT user_id, username, password, email, is_active FROM users WHERE username=:username;";
